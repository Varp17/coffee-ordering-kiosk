...
// ── TUNE IMAGE POSITION ───────────────────────────────
// Adjust the values below to move/zoom each cup image:
//   patternScale : 1 = normal, >1 = zoom in, <1 = zoom out
//   patternX     : positive = move right, negative = move left
//   patternY     : positive = move down, negative = move up
// ──────────────────────────────────────────────────────

// eslint-disable-next-line react-refresh/only-export-components
export const WHY_CHILLD_ITEMS = [
  {
    id: 'one',
    number: '01',
    title: 'Built for the grind',
    description: 'Heavy monday, extra shot, light friday, one less. you run the dial',
    rotation: '-7.58deg',
    viewBox: '113 2517 238 340',
    bodyPath: 'M190.482 2853.73L134.217 2612.59C133.811 2610.85 134.993 2609.14 136.763 2608.91L335.802 2582.43C337.594 2582.19 339.193 2583.57 339.224 2585.38L343.558 2833.42C343.584 2834.96 342.455 2836.27 340.933 2836.47L193.826 2856.04C192.282 2856.24 190.836 2855.24 190.482 2853.73Z',
    ...
    image: '/images/Why Chilld Cups/girl1.png',
    patternScale: 1.5,
    patternYShift: 40,
    lidColor: '#B89047',
    textXOffset: '12px',
  },
  {
    ...
    image: '/images/Why Chilld Cups/men1.png',
    patternScale: 1.55,
    patternYShift: 55,
    lidColor: '#1F2A44',
    textXOffset: '-12px',
  },
  {
    ...
    number: '03',
    title: 'Time is Money',
    description: 'Nobody ever got a promotion standing in a coffee queue',
    rotation: '-3.09deg',
    viewBox: '798 2582 238 329',
    bodyPath: 'M853.299 2908.25L816.079 2663.45C815.811 2661.68 817.123 2660.07 818.906 2659.97L1019.41 2649.16C1021.21 2649.06 1022.7 2650.56 1022.59 2652.36L1007.49 2899.98C1007.4 2901.52 1006.17 2902.74 1004.64 2902.82L856.451 2910.81C854.897 2910.9 853.533 2909.79 853.299 2908.25Z',
    ...
    image: '/images/Why Chilld Cups/girl2.png',
    transform: 'rotate(-2)',
    patternScale: 1.5,
    patternYShift: 35,
    lidColor: '#BFC1C2',
  ...
  },
  {
    ...
    description: "Don't pay for pendant lights and latte art, just the coffee",
    rotation: '9.37deg',
    ...
    image: '/images/Why Chilld Cups/girl3.png',
    transform: 'rotate(2)',
    patternScale: 1.5,
    patternYShift: 45,
    lidColor: '#E2E8F0',
...
const WhyChilldCup = forwardRef(function WhyChilldCup({
  ...
  const tx = vbx - (vw * (s - 1)) / 2;
  const ty = vby - (vh * (s - 1)) / 2 + (item.patternYShift || 0);
