  ...
  return (
    <div className="homepage-figma-container">
      ...
      <div className="figma-svg-wrapper">
        ...
        {/* The Figma SVG already contains the two wavy brand lines.
            Do not render a second React marquee here: duplicate text shifts on Vercel. */}
