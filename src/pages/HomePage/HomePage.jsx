      ...
      <section className="lower-flow-b2b" aria-labelledby="lower-flow-b2b-title">
        <div className="lower-flow-b2b__content">
          ...
          <div className="lower-flow-b2b__cta">
            ...
            <Link to="/contact">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>
